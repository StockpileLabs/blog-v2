...
import { f as formatDate, $ as $$Tags, g as getCollection, c as capitalize } from './__rFkB4VW2.mjs';
...
const $$ = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, {}, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<h1 class="text-2xl pb-3">${capitalize(tag)}</h1> <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3"> ${tagArticles.map((article) => renderTemplate`${renderComponent($$result2, "ArticleCard", $$ArticleCard, { "article": article })}`)} </div> ` })}`;
}, "/workspaces/blog-v2/src/pages/articles/tag/[...tag].astro", void 0);

const $$file = "/workspaces/blog-v2/src/pages/articles/tag/[...tag].astro";
